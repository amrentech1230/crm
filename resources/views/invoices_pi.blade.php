                        ...
                        <div class="invoice-info clearfix" id="invoice_wrapper">
                            <div class="invoice-headar">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="logo">
                                            <img src="{{ asset('public/images/logo-with-cci.png') }}">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="invoice-id">
                                            <div class="info">
                                                ...
                                                <p>Rosemont Business Campus</p>
                                                <p>919 Conestoga Road Bldg. 3 Suite 215 Bryn Mawr, PA 19010</p>
                                                <p>610-400-7068</p>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="invoice-id">
                                            <div class="info">
                                                ...
                                                <table class="table table-bordered">
                                                    <tr>
                                                        <td style="width:60%">
                                                            <p class="mb-1"><b>Date:</b> <span>{{date('m/d/Y')}}</span>
                                                            </p>
                                                        </td>
                                                    </tr>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="invoice-number mb-30">
                                            ...
                                            <p class="invo-addr-1">
                                                ...
                                                <p>{{$customer->customer_address ?? ''}}
                                                    {{$customer->customer_city ?? ''}},
                                                    {{$customer->customer_state ?? ''}},
                                                    {{$customer->customer_zip ?? ''}},
                                                    {{ preg_replace('/^\d+\s*/', '', $customer->customer_country ?? '') }}
                                                </p>
                                            </p>
                                        </div>
                                    </div>
                            ...
                            <div class="invoice-top">
                                <table class="table table-bordered">
                                    ...
                                    <tr>
                                        <td colspan="3"></td>
                                        <td><b>SUBTOTAL LESS DISCOUNT :</b></td>
                                        <td>${{$total_amount}}</td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td colspan="3"></td>
                                        <td><b>PRE ADVANCE :</b></td>
                                        <td>{{$pre_advance_amount}}</td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <b>${{$total_amount - $pre_advance_amount}}</b>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td colspan="5" class="text-center">
                                            <strong>
                                                Your insights and experiences are invaluable to us. If you have any
                                                feedback,
                                                suggestions, or concerns, please don’t hesitate to reach out to us at
                                                <a href="mailto:feedback@cargoconvoy.co">feedback@cargoconvoy.co</a>
                                            </strong>
                                        </td>
                                    </tr>
