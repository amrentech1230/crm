...
<body>
  <section class="rate-load-confirmation">
                        ...
                        <div class="direction">
                            ...
                            <div class="disspatch" >
                                <table class="info" style="margin-top:20px;margin-bottom:30px;margin-left:20px;">
                                    ...
                                    <tr>
                                        <td colspan="2">
                                            <p style="background-color:#ffff77; padding:8px; font-weight:bold;">
                                                Kindly forward all required paperwork to ap@cargoconvoy.co <br>so that the payments are processed in timely manner.
                                            </p>
                                        </td>
                                    </tr>
                                </table>
                        ...
                        <table style="width:100%">
                            ...
                            <tr>
                                ...
                                <tr>
                                    ...
                                    <!-- @php
                                        $address = $shipperLocation[$key]['location'] ?? '';
                                        $addressParts = explode(' ', $address);

                                        // Check if there are enough words to perform the removal
                                        if (count($addressParts) > 2) {
                                            // If the second-last word is "United," remove the third-last word
                                            if ($addressParts[count($addressParts) - 2] === 'United') {
                                                unset($addressParts[count($addressParts) - 3]);
                                            } else {
                                                // Otherwise, remove the second-last word
                                                unset($addressParts[count($addressParts) - 2]);
                                            }
                                        }
                            ...
                            <tr>
                               <td style="width:35% !important">
                                    <p><b>Commodity:</b> {{ isset($shipper_commodity[$key]['commodity']) ? $shipper_commodity[$key]['commodity'] : '' }}</p>
                                </td>
                ...
                <h3>Consignee {{ $counter++ }}</h3>
                    <table style="width:100%">
                        ...
                        <tr>
                            ...
                            <td style="width:35% !important">
                                <p><b>Date:</b>  
                                    @if(isset($consignee_appointment[$key]['appointment']) && \Carbon\Carbon::hasFormat($consignee_appointment[$key]['appointment'], 'Y-m-d\TH:i'))
                                        {{ \Carbon\Carbon::parse($consignee_appointment[$key]['appointment'])->format('m-d-Y, h:i:s A') }}
                                    @else
                                        {{ '' }}
                                    @endif
                                </p>
        ...
        <div class="content">
                        ...
                        <p>5. All invoices must be emailed to ap@cargoconvoy.co along with proof of delivery,
                            bill of lading,
                        ...
                        <p style="margin-bottom:10px;"><b>All the emails for rate verifications should go to verification@cargoconvoy.co and NOT be sent to ap@cargoconvoy.co</b></p>
