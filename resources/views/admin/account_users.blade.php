...
$(document).ready(function () {
    ...
    $('form.app-search .position-relative').attr('id', 'accounts');

    function initializeTab() {
        const inputSelector = 'input[name="query"]';
        const ajaxUrl = "{{route('account_users_search')}}";
        const resultContainer = '#accounts-data';
