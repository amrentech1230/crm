...
@php
                                ...
                                <tr>
                                    ...
                                    <td class="dynamic-data hide_blur_privacy" id="load_number1" style="vertical-align: middle !important;">
                                    <a href="{{ route('load.edit', $s->id) }}" style="color: rgb(10 185 90) !important; font-weight: 700; cursor: pointer;">{{ $s->load_number }}</a>
                                    </td>
