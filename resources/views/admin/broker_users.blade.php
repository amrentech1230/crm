                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <thead>
                                            ...
                                            <tbody id="broker-data">
                                            @include('admin.users.brokers')
                                            </tbody>
                                        </table>
...
$(document).ready(function () {
    ...
    $('form.app-search .position-relative').attr('id', 'broker');

    function initializeTab() {
        const inputSelector = 'input[name="query"]';
        const ajaxUrl = "{{route('broker_users_search')}}";
        const resultContainer = '#broker-data';
