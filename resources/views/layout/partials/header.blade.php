...
<header id="page-topbar">
    <div class="navbar-header">
        <div class="d-flex">
            ...
            <div
                style="text-align: center;font-size: 20px;font-family: Verdana, Arial, Helvetica, sans-serif;margin: 19px 0 0 0px;color: #fff;">
                CARGO CONVOY INC
            </div>
        ...
        <div class="d-flex">
            ...
            <div class="dropdown d-inline-block user-dropdown">
                <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
                    data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    @if(isset(Auth::user()->profile_picture) && file_exists(public_path(Auth::user()->profile_picture)))
                    <img class="rounded-circle header-profile-user"
                        src="{{ asset(Auth::user()->profile_picture) }}" alt="Header Avatar">
                    @else
                    <img class="rounded-circle header-profile-user"
                        src="https://cargoconvoy.co/wp-content/uploads/2025/09/Amren_1753880051.png"
                        alt="Default Avatar">
                    @endif
...
<div class="vertical-menu">
    ...
    <div data-simplebar class="h-100">
        ...
        <div class="user-profile text-center mt-3">
            ...
            <div class="profile-user mb-3" style="margin: 10px 0 0 0;">
                @if(isset(Auth::user()->profile_picture) && file_exists(public_path(Auth::user()->profile_picture)))
                <img src="{{ asset(Auth::user()->profile_picture) }}" alt="Profile Picture" width="100px"
                    height="100px" class="rounded-circle">
                @else
                <img src="https://cargoconvoy.co/wp-content/uploads/2025/09/Amren_1753880051.png" alt="Default Picture"
            ...
            <div class="mt-3">
                ...
                <span class="text-muted"> <span
                        class="text-muted">{{ Auth::user()->role->name ?? 'No Role Assigned' }}</span>
                </span>
            </div>
        </div>
        ...
        <div id="sidebar-menu">
            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                @endif
                @if(isset($userMenus) && in_array('Add New user', $userMenus) || in_array('Broker Users List',
                $userMenus) || in_array('Department', $userMenus) || in_array('Manager', $userMenus) || in_array('Team
                leader', $userMenus) || in_array('Status Type', $userMenus) || in_array('Shipment Type', $userMenus) ||
                in_array('Equipment Type', $userMenus) || in_array('Country', $userMenus) || in_array('State',
                $userMenus))
                <li>
                ...
                @endif
                @if(isset($userMenus) && in_array('Broker users list', $userMenus) || in_array('Account users list',
                $userMenus) || in_array('Admin users list', $userMenus))
                <li>
                    <a href="javascript: void(0);" class="has-arrow waves-effect">
                ...
                <li>
                    <a href="{{route('accounting')}}" class=" waves-effect">
                        ...
                        <span>AR Accounting</span>
                    </a>
                </li>
                @endif
                @if(isset($userMenus) && in_array('Remittance', $userMenus))
                <li>
                    <a href="{{route('remittance')}}" class=" waves-effect">
                        <i class="fas fa-user-cog"></i>
                ...
                @endif
                @if(isset($userMenus) && in_array('Credit', $userMenus))
                <li>
                ...
                @endif
                @if(isset($userMenus) && in_array('tickets', $userMenus))
                <li>
                    <a href="{{route('it.hardware')}}" class=" waves-effect">
                        <i class="fas fa-truck-moving"></i>
                        <span>Tickets</span>
                    </a>
                </li>
                @endif
                @if(isset($userMenus) && in_array('raise tickets', $userMenus))
                <li>
                    <a href="{{route('broker.raise.tickets')}}" class=" waves-effect">
                        <i class="fas fa-truck-moving"></i>
                ...
                @endif
                <li>
                    <a href="https://dndlist.in/" target="_blank" class=" waves-effect">
                        <i class=" fas fa-truck-loading"></i>
                        <span>DND</span>
                    </a>
                </li>
                @if(isset($userMenus) && in_array('Vendor System', $userMenus))
                <li>
                    <a href="{{route('carrier_verification')}}" class=" waves-effect">
                        <i class="fas fa-truck"></i>
                        <span>Carrier Verification</span>
                    </a>
                </li>
                @endif
                @if(isset($userMenus) && in_array('Customer Approval Form Admin', $userMenus))
                <li>
                    <a href="{{route('customer.approval.form.admin')}}" target="_blank" class=" waves-effect">
                        <i class=" fas fa-truck-loading"></i>
                        <span>Customer Approval Form</span>
                    </a>
                </li>
                @endif
                @if(isset($userMenus) && in_array('Customer Approval Form', $userMenus))

                <li>
                    <a href="{{route('customer.approval.form.broker')}}" class=" waves-effect">
                        <i class="fas fa-truck-moving"></i>
                        <span>Customer Approval Form</span>
                    </a>
                </li>
                @endif
                @if(isset($userMenus) && in_array('factoring', $userMenus))
                <li>
                    <a href="{{route('factoring.show')}}" class=" waves-effect">
                        <i class="fas fa-truck-moving"></i>
                        <span>Factoring</span>
                    </a>
                </li>
                @endif
                @if(isset($userMenus) && in_array('cmt', $userMenus))
                <li>
                    <a href="{{route('cmt.data')}}" class=" waves-effect">
                        <i class="fas fa-truck-moving"></i>
                        <span>CMT</span>
                    </a>
                </li>
