                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0">Account Users</h4>
                                        ...
                                        <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                            ...
                                            @endphp
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="dynamic-data">{{ $getaccount->emergency_contact }}</td>
                                                <td class="dynamic-data">{{ $getaccount->created_at ? \Carbon\Carbon::parse($getaccount->created_at)->format('m-d-y') : '' }}</td>
                                                    <td class="dynamic-data" style="text-align: center;">
                                                        ...
                                                        <button class="btn update-password-btn" data-bs-toggle="modal" data-bs-target="#updatePasswordModal" title="Change Password" data-id="{{ $getaccount->id }}" data-name="{{ $getaccount->name }}"><i class="fa fa-lock" style="color: #ff9d20;"></i></button>
