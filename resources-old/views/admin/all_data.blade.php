                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <ul class="nav nav-tabs nav-tabs-custom nav-justified" role="tablist">
                                            ...
                                            <li class="nav-item" role="presentation">
                                                <a class="nav-link" data-bs-toggle="tab" href="#carrier" role="tab" aria-selected="false" tabindex="-1">
                                                    <span class="d-block d-sm-none"><i class="far fa-user"></i></span>
                                                    <span class="d-none d-sm-block">Carrier</span> 
                                                </a>
                                            </li>
                                            <li class="nav-item" role="presentation">
                                                <a class="nav-link" data-bs-toggle="tab" href="#consignee" role="tab" aria-selected="false" tabindex="-1">
                                                    <span class="d-block d-sm-none"><i class="far fa-user"></i></span>
                                                    <span class="d-none d-sm-block">Consignee</span> 
                                                </a>
                                            </li>
                                            <li class="nav-item" role="presentation">
                                                <a class="nav-link" data-bs-toggle="tab" href="#shipper" role="tab" aria-selected="false" tabindex="-1">
                                                    <span class="d-block d-sm-none"><i class="far fa-envelope"></i></span>
                                                    <span class="d-none d-sm-block">Shipper</span>   
                                                </a>
                                            </li>
                                            <li class="nav-item" role="presentation">
                                                <a class="nav-link" data-bs-toggle="tab" href="#load" role="tab" aria-selected="false" tabindex="-1">
                                                    <span class="d-block d-sm-none"><i class="far fa-envelope"></i></span>
                                        ...
                                        <div class="tab-content p-3 text-muted">
                                            <div class="tab-pane active" id="customer" role="tabpanel">
                                                ...
                                                <table id="datatable-buttons-customer" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                                    <thead>
                                                    <tr>
                                                        <th>Sr No.</th>
                                                        <th>Agent</th>
                                            ...
                                            <div class="tab-pane" id="carrier" role="tabpanel">
                                                <table id="datatable-buttons-carrier" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                                    <thead>
                                                        <tr>
                                                            <th>Sr No.</th>
                                                            <th>Carrier Name</th>
                                            ...
                                            <div class="tab-pane" id="consignee" role="tabpanel">
                                                <table id="datatable-buttons-consignee" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                                    <thead>
                                                        <tr>
                                                            <th>Sr No</th>
                                            ...
                                            <div class="tab-pane" id="shipper" role="tabpanel">
                                                <table id="datatable-buttons-shipper" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                                    <thead>
                                                        <tr>
                                                            <th>Sr No.</th>
                                                            <th>Shipper Name</th>
                                            ...
                                            <div class="tab-pane" id="load" role="tabpanel">
                                                <table id="datatable-buttons-load" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                                    <thead>
                                                        <tr>
                                                            <th>Sr No</th>
                                                            <th>Load #</th>
...
$(document).ready(function() {
    const tables = {
        '#customer': { selector: '#datatable-buttons-customer', initialized: false },
        '#carrier': { selector: '#datatable-buttons-carrier', initialized: false },
        '#consignee': { selector: '#datatable-buttons-consignee', initialized: false },
        '#shipper': { selector: '#datatable-buttons-shipper', initialized: false },
        '#load': { selector: '#datatable-buttons-load', initialized: false }
    };
