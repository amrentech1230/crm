                        ...
                        <div class="invoice-info clearfix" id="invoice_wrapper">
                                        ...
                                        <div class="invoice-id">
                                            <div class="info">
                                                ...
                                                <table class="table table-bordered">
                                                    ...
                                                    <tr>
                                                    <td style="width:40%"><p class="mb-0"><b>Invoice Date:</b><span>{{ \Carbon\Carbon::parse($invoice->invoice_date)->format('m-d-Y') }}</span></p></td>

                                                        <td style="width:60%"><p class="mb-0"><b>Terms:</b> <span> {{ $invoice->invoicing_payment_terms ?? 'Net 30' }}</span></p></td>
                                                    </tr>
                                                    <tr>
                            ...
                            <div class="invoice-top">
                                    ...
                                    <div class="detail">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <p><b>Date:</b> {{ isset($shipper_appointment_date[$key]['appointment']) ? \Carbon\Carbon::parse($shipper_appointment_date[$key]['appointment'])->setTimezone('America/New_York')->format('m-d-Y') : '' }}</p>
                                ...
                                <h6><b>RATES AND CHARGES</b></h6>
                                    ...
                                    <div class="d-flex justify-content-between">
                                        <p class="m-0"><span style="color:red;">*</span><span style="color:red;margin-right: 10px;">*</span><strong>Important Notice:</strong> Our banking information has been updated. Please update your records with the new details below and share all the payment remittances at <strong> ar@cargoconvoy.co</strong></p>
